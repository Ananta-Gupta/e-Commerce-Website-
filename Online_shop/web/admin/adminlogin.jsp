		...
		<div class="container">
					...
					<div class="login-form">
						...
						<p class="text-center mt-80 mb-40">Welcome back! Sign in to your account </p>
                                                <form action="login.jsp">
                                                    <input type="text" placeholder="Username or Email*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Username or Email*'" required class="common-input mt-20" name="user">
            ...
            <section class="banner-area organic-breadcrumb"></section>

                ...
                <div class="menutop-wrap">
                    <div class="menu-top container">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <ul class="list">
                                <li><a href="user/userpage.jsp">My Account</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="confermation.jsp">Confermation</a>
					...
					<div class="login-form">
						...
						<p class="text-center mt-80 mb-40">Welcome back! Sign in to your account </p>
                                                <form action="login.jsp">
                                                    <input type="hidden" name="rurl" value="<%out.print(url);%>">
                                                    <input type="text" placeholder="email*" onfocus="this.placeholder=''" onblur="this.placeholder = 'email*'" required class="common-input mt-20" name="email">
                                                    <input type="password" placeholder="Password*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Password*'" required class="common-input mt-20" name="pass">
					...
					<div class="register-form">
						...
						<p class="text-center mt-40 mb-30">Create your very own account </p>
                                                <form action="userreg.jsp">
                                                    <input type="text" placeholder="First name*" onfocus="this.placeholder=''" onblur="this.placeholder = 'First name*'" required class="common-input mt-20" name="Fname">
                                                    <input type="text" placeholder="Last name*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Last name*'" required class="common-input mt-20" name="Lname">
                                                    ...
                                                    <input type="text" placeholder="Phone number*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Phone number*'" required class="common-input mt-20" name="mob_no">
                                                    <input type="text" placeholder="Username*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Username*'" required class="common-input mt-20" name="username">
                                                    <input type="password" placeholder="Password*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Password*'" required class="common-input mt-20" name="pass">
